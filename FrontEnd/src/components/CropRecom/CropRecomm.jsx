...
const CropRecommendation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const data = {nitrogen,phosphorous,potassium,ph,temperature,rainfall,humidity,state,district}
    ...
    >
      ...
      >
        <div className="mb-4">
          ...
          <input
            ...
            name="phosphorous"
            type="number"
            placeholder="Enter the Phosphorous Content"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            name="potassium"
            type="number"
            placeholder="Enter the Potassium Content"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            name="nitrogen"
            type="number"
            placeholder="Enter the Nitrogen Content"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            name="ph"
            type="number"
            placeholder="Enter the pH Content of Soil"
            required
          />
        </div>
        <div className="mb-4">
      ...
      {prediction && (
          <div className="p-2 w-full md:max-w-lg bg-[#cdf1c7] shadow-md rounded px-8 pt-6 pb-8 mb-4">
            Best Suitable Crop for Given Conditions is: <p className="text-2xl font-bold">{prediction}</p>
          </div>
        )}
